...
/* -----------------------------------------------------------------------
   TABLE — Compound table primitive
   Usage: <Table> → <TableHeader> → <TableRow> → <TableHead> / <TableCell>
   ----------------------------------------------------------------------- */
...
const TableRow = forwardRef<HTMLTableRowElement, HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        "border-b border-border transition-colors duration-fast hover:bg-surface-sunken",
